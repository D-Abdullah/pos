...
<div class="menu">
    ...
    <div class="apps-pages">
        ...
        <div
            class="list {{ Request::is('warehouse-transaction/all') ? 'active' : '' }} transaction d-flex justify-content-between align-items-center">
        ...
        @can('read client')
            <div
                class="list {{ Request::is('client/all') ? 'active' : '' }} customers d-flex justify-content-between align-items-center">
        ...
        @can('read eol')
            <div
                class="list {{ Request::is('eol/all') ? 'active' : '' }} perished d-flex justify-content-between align-items-center">
        ...
        @can('read user')
            <div
                class="list  {{ Request::is('user/all') ? 'active' : '' }} data-users d-flex justify-content-between align-items-center">
        ...
        @can('read role')
            <div
                class="list  {{ Request::is('role/all') ? 'active' : '' }} jobs d-flex justify-content-between align-items-center">
        ...
        @can('read rent')
            <div
                class="list  {{ Request::is('rent/all') ? 'active' : '' }} rent d-flex justify-content-between align-items-center">
        ...
        @can('read party')
            <div
                class="list  {{ Request::is('party/all') ? 'active' : '' }}  concerts d-flex justify-content-between align-items-center">
