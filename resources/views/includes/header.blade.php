...
<header class="shadow-sm rounded-3 ps-4 pe-4 d-flex justify-content-between align-items-center">
    ...
    <div class="up d-flex align-items-center gap-4">
        ...
        <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
            <svg class="pointer" xmlns="http://www.w3.org/2000/svg" width="26" height="27"
                 viewBox="0 0 26 27"
                 fill="none">
                <path d="M13 5.52753V20.6942" stroke="#4B465C" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M13 5.52753V20.6942" stroke="white" stroke-opacity="0.2" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M5.41663 13.1108H20.5833" stroke="#4B465C" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M5.41663 13.1108H20.5833" stroke="white" stroke-opacity="0.2"
                      stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <button>انشئ بسرعه</button>
            <div class="options none">
                <ul>
                    <li class="active">انشئ بسرعه</li>
                    <li>فئه 1</li>
                    <li>فئه 2</li>
                    <li>فئه 3</li>
                </ul>
    ...
    <div class="info position-relative d-flex align-items-center justify-content-end">
        <div class="avatar ">
            <img class="pointer" src="{{ asset('Assets/imgs/Avatar.png') }}" alt="">
        </div>
        <div class="manage position-absolute none">
            <ul>
                <li class="position-relative">
                    <svg class="position-absolute" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <path d="M3 21V19C3 16.7909 4.79086 15 7 15H11C13.2091 15 15 16.7909 15 19V21"
                              stroke="#46515C" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path d="M3 21V19C3 16.7909 4.79086 15 7 15H11C13.2091 15 15 16.7909 15 19V21"
                              stroke="white" stroke-opacity="0.2" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M16 11L18 13L22 9" stroke="#46515C" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M16 11L18 13L22 9" stroke="white" stroke-opacity="0.2"
                              stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
