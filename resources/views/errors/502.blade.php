...
<body>
    <div class="error-container">
        ...
        <img src="{{ asset('Assets/imgs/502.png') }}" alt="Error 404 Image" class="error-img img-fluid mb-0">
        <h1 class="h4 fw-bolder mt-2 mb-4">عذرًا، حدث خطأ أثناء محاولة الوصول إلى الموقع. </h1>
