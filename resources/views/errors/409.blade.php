...
<body>
    <div class="error-container">
        ...
        <h1 class="h4 fw-bolder mt-2 mb-4">عذرًا، الطلب الحالي يتعارض مع حالة الموارد الحالية على الخادم. يرجى التحقق من البيانات المرسلة مع الطلب ومحاولة إعادة المحاولة بطريقة تتجنب أي تعارض.</h1>
