...
<body>
    <div class="error-container">
        ...
        <h1 class="h4 fw-bolder mt-2 mb-4">عذرًا، لقد انتهت مدة انتظار الخادم للطلب الذي تم إرساله. يرجى التحقق من اتصالك بالإنترنت ومحاولة إعادة إرسال الطلب مرة أخرى.</h1>
