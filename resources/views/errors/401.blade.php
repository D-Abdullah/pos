...
<body>
    <div class="error-container">
        ...
        <img src="{{ asset('Assets/imgs/401.png') }}" alt="Error 404 Image" class="error-img img-fluid mb-0">
        <h1 class="h4 fw-bolder mt-2 mb-4">عذرًا، لا يمكن الوصول إلى الموارد المطلوبة</h1>
