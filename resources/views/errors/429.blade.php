...
<body>
    <div class="error-container">
        ...
        <h1 class="h4 fw-bolder mt-2 mb-4">عذرًا، تم رفض الطلب الحالي لأنك قمت بإرسال العديد من الطلبات في فترة زمنية قصيرة جدًا. يرجى الانتظار لبضع دقائق ومحاولة إعادة الطلب مرة أخرى.</h1>
