    ...
    <section class="pt-0 rounded-3 position-relative shadow-sm overflow-auto">
        ...
        <div class="features shadow-sm p-4 d-flex justify-content-between align-items-end">
            ...
            <div class="component-left me-3 gap-4 d-flex align-items-center">
                <div class="select-btn select position-relative rounded-3 d-flex  border-0 align-items-center">
                    ...
                    <tr>
                            ...
                            <div class="popup-edit id-{{ $eol->id }} popup close shadow-sm rounded-3 position-fixed">
                                <form id="edit-cate" method="post" action="{{ route('eol.update', $eol->id) }}">
                                    ...
                                    <div class="f-row d-flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select class="js-example-basic-single edit" name="product_id"
                                                ...
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id }}"
                                                        {{ $eol->product_id == $product->id ? 'selected' : '' }}>
                                                        {{ $product->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div>
                                        ...
                                        <textarea class="category-input" name="reason" id="textarea" cols="30" rows="10"
                                            placeholder="سبب الهالك">{{ $eol->reason }}</textarea>
                                    </div>
                        ...
                        <div class="popup-delete popup close shadow-sm rounded-3 position-fixed">
                            ...
                            <div class="buttons mt-5 d-flex">
                                <button onclick="fnDelete('{{ $eol->id }}')" class="agree rounded-2">نعم
                                    أريد</button>
...
@section('script')
    ...
    <script>
        ...
        function fnDelete(id) {
            ...
            form.setAttribute('action', `{{ url('eol') }}/${id}`);
