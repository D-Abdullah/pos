    ...
    <form method="post" action="{{route('supplier.add')}}">
        ...
        <div class="f-row d-flex gap-4">
            <div>
                ...
                <input type="text" name="name" id="category-name" placeholder="اسم المورد">
            </div>
            <div>
                <label class="d-block mb-1" for="phone-number"> رقم الهاتف</label>
                <input type="number" minlength="11" name="phone" id="phone-number" placeholder="رقم الهاتف">
            </div>
        </div>
        <div class="f-row d-flex gap-4">
            <div>
                <label class="d-block mb-1" for="buy-price">العنوان</label>
                <input type="text" name="address" id="buy-price" placeholder="العنوان">
            </div>
            <div class="">
                <label class="d-block mb-1" for="sale-buy">البريد الالكتروني</label>
                <input type="text" name="email" id="sale-buy" placeholder="البريد الالكتروني ">
            </div>
        </div>
        ...
        <button class="main-btn" type="submit">اضافه</button>
</div>
