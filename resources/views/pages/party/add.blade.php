...
@section('content')
                ...
                <div class="components">
                    <div class="parent gap-3 mb-4 d-flex">
                        ...
                        <div>
                            ...
                            <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueDateAddLast', 'listDateAddLast')">
                        ...
                        <div class="select-form">
                            <label>الحاله</label>
                            <div class="select-btn w-100 mt-1 select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueStatusSix', 'listStatusSix')">
                    ...
                    <div class="buttons gap-3 mb-3 d-flex align-items-center">
                        <svg class="pointer" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 49 49" fill="none">
                            <rect x="0.203125" y="0.0437012" width="48" height="48" rx="8" fill="#7367F0"/>
                            <path d="M24.2031 10.0437V38.0437" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M10.2031 24.0437H38.2031" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="elements">
                ...
                <div class="mt-5 mb-5 special">
                    <button class="secound-btn active-btn total-product mb-2" id="ourProduct" style="padding: 15px; width: 170px;">منتجاتنا</button>
                    <button class="me-2 secound-btn element-found mb-2" id="rent" style="padding: 15px; width: 170px;">ايجار</button>
                    <button class="secound-btn element-not-found mb-2 style=" id="specialConcert" style="padding: 15px; width: 170px;">مخصص</button>
                </div>
                    ...
                    <div class="products">
                        <div class="info p-2 mb-1 d-flex gap-4 align-items-center">
                            ...
                            <div class="select-btn w-50 select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueDateAddLast3', 'listDateAddLast3')">
                        ...
                        <div class="up p-2 d-flex justify-content-between overflow-auto">
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">كوشه</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">حزاء</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">خزنه</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">ملابس</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">العاب</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">سيارات</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">شنطه</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                ...
                <div class="part gap-4" id="rent">
                    <div class="products w-50">
                        ...
                        <div class="up p-2 d-flex justify-content-between overflow-auto">
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">زهره</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">مأكولات</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                            ...
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">تيشيرتات</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">كتب</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                                <img src="./Assets/imgs/bag.jpeg" alt="">
                                <div class="info-box p-3">
                                    <span class="d-block fs-5">موتوسيكلات</span>
                                    <span class="fs-5">1500 ج.م</span>
                                </div>
                            </div>
                            <div class="box">
                    ...
                    <div class="carts rounded-3 w-50 d-flex flex-column justify-content-between overflow-auto">
                        <div class="elements">
                            <div class="info d-flex gap-3 justify-content-evenly">
                                <span>الاسم</span>
                                <span>الكميه</span>
                        ...
                        <div class="total active-btn" id="totalPrice">اجمالي السعر 900</div>
                    </div>
                </div>
                ...
                <div class="part gap-4" id="specialConcert">
                    ...
                    <div class="carts rounded-3 w-50 d-flex flex-column justify-content-between ">
                        <div class="elements">
                            <div class="info d-flex gap-3 justify-content-evenly">
                                <span>الاسم</span>
                                <span>الكميه</span>
                ...
                <div class="w-100 d-flex justify-content-end mt-5 mb-5" id="addNewProduct">
                    <button class="submit main-btn p-3 ps-4 pe-4">اضافه</button>
                </div>
                ...
                <div class="popup-add popup close shadow-sm rounded-3 position-fixed" id="popupAddOurProduct">
                    ...
                    <div class="f-row d-flex gap-4">
                        ...
                        <div class="select-form">
                            ...
                            <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueCategoriesNameAdd', 'listCategoriesNameAdd')">
                ...
                <div class="popup-edit popup close shadow-sm rounded-3 position-fixed" id="popupEditOurProduct">
                    ...
                    <div class="f-row d-flex gap-4">
                        ...
                        <div class="select-form">
                            <label for="">النوع</label>
                            <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueCategoriesNameEdit', 'listCategoriesNameEdit')">
                ...
                <div class="popup-add popup close shadow-sm rounded-3 position-fixed" id="popupAddRent">
                    ...
                    <div class="f-row d-flex gap-4">
                        ...
                        <div class="select-form">
                            <label for="">النوع</label>
                            <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueCategoriesNameAdd2', 'listCategoriesNameAdd2')">
                ...
                <div class="popup-edit popup close shadow-sm rounded-3 position-fixed" id="popupEditRent">
                    ...
                    <div class="f-row d-flex gap-4">
                        ...
                        <div class="select-form">
                            <label for="">النوع</label>
                            <div class="select-btn select position-relative rounded-3 d-flex align-items-center">
                                <button class="w-100 d-flex justify-content-between" onclick="dropdown('valueCategoriesNameEdit3', 'listCategoriesNameEdit3')">
