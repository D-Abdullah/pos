...
@section('content')
    ...
    <div class="mt-5 mb-5 special">
        <button class="secound-btn active-btn total-product mb-2" id="ourProduct"
            style="padding: 15px; width: 170px;">منتجاتنا</button>
        <button class="me-2 secound-btn element-found mb-2" id="rent" style="padding: 15px; width: 170px;">ايجار</button>
        <button class="secound-btn element-not-found mb-2 style=" id="specialConcert"
            style="padding: 15px; width: 170px;">مخصص</button>
    </div>
