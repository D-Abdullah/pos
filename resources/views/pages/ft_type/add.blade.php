<div class="popup-add popup close shadow-sm rounded-3 position-fixed">
    ...
    <form id="add-cate" method="post" action="{{ route('ft.type.add') }}">
        @csrf
        <h2 class="text-center mt-4 mb-4 opacity-75">اضافة نوع معامله ماليه جديد</h2>
        <div class="f-row d-flex gap-4">
            <div>
                <label class="d-block mb-1" for="customer-name">اسم نوع المعامله الماليه</label>
                <input class="category-input" type="text" name="name" id="customer-name"
