                    ...
                    <tr>
                        ...
                        <td>
                            <div class="edit d-flex align-items-center justify-content-center">
                                @can('update role')
                                    <img src="{{asset('Assets/imgs/edit-circle.png')}}" alt="" data-id="{{$role->id}}"
                                         id="edit">
                                @endcan
                                @can('delete role')
                                        ...
                                        <div>
                                            ...
                                            >
                                                @foreach($permissions as $permission)
                                                    <option
                                                        value="{{ $permission['org'] }}" {{ in_array($permission['org'], $role->permissions->pluck('name')->toArray()) ? 'selected' : '' }}>
                                                        {{ $permission['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
            ...
            <div class="table-control d-flex justify-content-between align-items-center">
                ...
                <div class="info-table opacity-50">
                    <p>عرض <span>{{ $roles->firstItem() }}</span> إلى <span>{{ $roles->lastItem() }}</span>
                        من
                        <span>{{ $roles->total() }}</span> مدخلات</p>
                </div>
            </div>
        @endcan
    </section>
