                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p><?php echo e(trans('file.The correct column order is')); ?> (product_code, quantity, purchase_unit_code, cost, discount_per_unit, tax_name) <?php echo e(trans('file.and you must follow this')); ?>. <?php echo e(trans('file.All columns are required')); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/backend/purchase/import.blade.php ENDPATH**/ ?>