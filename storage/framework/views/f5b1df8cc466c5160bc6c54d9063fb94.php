<div class="tab-pane fade" id="versionUpgradeSetting" role="tabpanel" aria-labelledby="version-upgrade-setting">
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="<?php echo e(route('version-upgrade-setting.submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <!----------------------------------- Important Note ------------------------------------------>
                <hr>
                <h5><b><?php echo app('translator')->get('file.Short Note'); ?></b></h5>
                <hr>
                <div class="form-group row">
                    <div class="col-md-12">
                        <?php if(isset($versionUpgradeSettings->short_note)): ?>
                            <textarea name="short_note" class="form-control" rows="5"><?php echo e($versionUpgradeSettings->short_note); ?></textarea>
                        <?php else: ?>
...
<?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/developer_section/version_upgrade_setting.blade.php ENDPATH**/ ?>