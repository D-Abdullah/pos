...
<head>
    ...
    <meta name="author" content="<?php echo e($general_setting->developed_by); ?>">
    <meta name="copyright" content="<?php echo e($general_setting->developed_by); ?>">
...
<body>
    <div id="documenter_sidebar">
    	<a href="<?php echo e(URL::previous()); ?>"><img src="<?php echo e(url('logo', $general_setting->site_logo)); ?>" style="border: none;margin: 20px 20px 0;width: 180px"></a>
    ...
    <div id="documenter_content">
        <section id="documenter_cover">
            ...
            <hr>
            <ul>
                <li>By: <?php echo e($general_setting->developed_by); ?></li>
            </ul>
            <p><?php echo e($general_setting->site_title); ?> is a software that will help you to manage your inventory, accounting and hrm. We believe that this software is suitable for both wholesale and retail buisness model and an ideal product for any Super Shop. This user friendly software is fully responsive and has many features. Hope that this software will be helpful to manage your buisness inventory.</p>
        </section>
        ...
        <section id="install">
            ...
            <p>If you are installing on localhost, please keep in mind that you’ll need Internet for installation. After installation, you can use <?php echo e($general_setting->site_title); ?> without Internet. We suggest you use <strong>XAMPP</strong> for localhost. You can use other solutions like WAMP, MAMP etc. as well and installation process for all of them are same.</p><p>Create a folder inside htdocs folder inside your XAMPP installation. Now copy the zip folder you downloaded from Codecanyon to htdocs folder and unzip it there. Rename it to whatever you want. Say, you have named it- ‘my-folder’. Now start your XAMPP (or whatever you are using) and go to your browser and access <?php echo e($general_setting->site_title); ?> from your browser like- localhost/my-folder/.</p>
            ...
            <p>Upload the zip folder you downloaded from Codecanyon to your hosting and unzip it. Please make sure you configure your web hosting’s settings, so that it shows hidden files and folders (for reference- <a href="https://youtu.be/zvOC76TXOnA">How to enable hidden files and folders on cpanel</a>) This is to ensure that if you copy/move the contents from the unzipped folder to any other location, you copy all the files including ‘.htaccess’, ‘.env’ files which are necessary for the proper functioning of the software. Now you can access the folder where you have <?php echo e($general_setting->site_title); ?> from your browser.</p>
            ...
            <ul>
                <li>Congratulations! You have successfully installed <?php echo e($general_setting->site_title); ?>.<br>
        ...
        <section id="update">
            ...
            <ul>
                <li>Rename your previous database like <?php echo e($general_setting->site_title); ?>-backup.sql.</li>
                ...
                <li>After that delete the new database and rename the previous one with present database name like <?php echo e($general_setting->site_title); ?>-backup.sql to <?php echo e($general_setting->site_title); ?>.sql.</li>
            </ul>
        ...
        <section id="product">
            ...
            <p>In product section you will just add general information of a product. <strong>To add stock you have to purchase that product.</strong> You can create three types of product in <?php echo e($general_setting->site_title); ?>.</p>
            <ul>
                <li>Standard</li>
                <li>Digital</li>
        ...
        <section id="weight-scale-machine">
            ...
            <p><?php echo e($general_setting->site_title); ?> is compatible with weight scale machine. But you have to follow the rules strictly. In a weight scale machine the machine will give you a label of 13 digits barcode. Consider the following picture: </p>
            <p><img alt="" src="read_me/assets/images/weight_machine1.jpeg"></p>
            <p>Here first 7 digits are the product code which must be similar with the product code of <?php echo e($general_setting->site_title); ?>. Next 5 digits contains weight and the last digit is a random number. Whenever you put a product on a weight scale machine it will generate this type of label automatically. Then all you have to do is scan this label. Product's info and weight will be calculated automatically with <?php echo e($general_setting->site_title); ?>. But the product code must be same both for <?php echo e($general_setting->site_title); ?> and weight scale machine.</p>
        ...
        <section id="print-barcode">
            ...
            <P>You can print barcode with <?php echo e($general_setting->site_title); ?>. The available paper sizes are 36mm, 24mm and 18mm. Anything other than that might not work correctly. To print barcodes we highly recommend using <strong>Brother Label Printer.</strong></P>
        </section>
        ...
        <section id="reports">
            ...
            <p>You can create generate various reports automatically by using <?php echo e($general_setting->site_title); ?>.</p>
            <ul>
        ...
        <section id="support">
            ...
            <p>Thank you and  best wishes from <?php echo e($general_setting->developed_by); ?></p>
        </section>
    </div>
...
<?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/backend/documentation.blade.php ENDPATH**/ ?>