        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="<?php echo e(url('addon-list')); ?>" id="addon-list"> <i class="dripicons-flag"></i><span><?php echo e(trans('file.Addons')); ?></span></a></li>
            <?php if(\Schema::hasColumn('products', 'woocommerce_product_id')): ?>
                <li><a href="<?php echo e(route('woocommerce.index')); ?>"> <i class="fa fa-wordpress"></i><span>WooCommerce</span></a></li>
            <?php endif; ?>
            <?php if(in_array('ecommerce',explode(',',$general_setting->modules))): ?>
            <li><a href="#ecommerce" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-shopping-bag"></i><span><?php echo e(trans('file.ecommerce')); ?></span></a>
                <ul id="ecommerce" class="collapse list-unstyled ">
                    <?php echo $__env->make('ecommerce::backend.layout.sidebar-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </ul>
            </li>
            <?php endif; ?>
            <?php endif; ?>
            ...
            <?php endif; ?>
        </ul><?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/backend/layout/sidebar.blade.php ENDPATH**/ ?>