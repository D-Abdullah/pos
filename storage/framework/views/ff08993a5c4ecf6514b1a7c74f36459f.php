  ...
  <body class="<?php if($theme == 'dark'): ?>dark-mode dripicons-brightness-low <?php endif; ?>  <?php if(Route::current()->getName() == 'sale.pos'): ?> pos-page <?php endif; ?>" onload="myFunction()">
        ...
        <nav class="navbar">
            ...
            <li class="nav-item">
                    ...
                    <ul class="right-sidebar">
                        ...
                        <li>
                          <a href="<?php echo e(url('language_switch/swahili')); ?>" class="btn btn-link"> Swahili</a>
                        </li>
                    </ul>
            </li>
            <li class="nav-item">
              ...
              <div class="modal-body">
                <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                  <div class="row">
                      ...
                      <div class="col-md-6 form-group">
                          <label><?php echo e(__('Icon')); ?> (SVG format)</label>
                          <input type="file" name="icon" class="form-control">
                      </div> 
                      <div class="col-md-6 form-group">
                          <br>
                          <input type="checkbox" name="featured" id="featured" value="1"> <label><?php echo e(__('List on category dropdown')); ?></label>
                      </div>
                      <?php endif; ?>
                  </div>
    ...
    <script type="text/javascript">
      ...
      $("a#add-expense").click(function(e){
        ...
        $.ajax({
          url: "<?php echo e(route('expense_category.all')); ?>",
          type: 'GET',
          dataType: 'json',
        ...
        $.ajax({
          url: "<?php echo e(route('warehouse.all')); ?>",
          type: 'GET',
          dataType: 'json',
          success: function(data) {
        ...
        $.ajax({
          url: "<?php echo e(route('account.all')); ?>",
          type: 'GET',
          dataType: 'json',
          success: function(data) {
      ...
      $("a#customer-group-report-link").click(function(e){
        ...
        $('#loader').css('display','block');
        $.ajax({
          url: "<?php echo e(route('customer_group.all')); ?>",
          type: 'GET',
          dataType: 'json',
          success: function(data) {
      ...
      $("a#supplier-report-link").click(function(e){
        ...
        $('#loader').css('display','block');
        $.ajax({
          url: "<?php echo e(route('supplier.all')); ?>",
          type: 'GET',
          dataType: 'json',
          success: function(data) {
...
<?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/backend/layout/main.blade.php ENDPATH**/ ?>