                <div class="tab-pane fade show active" id="generalSetting" role="tabpanel" aria-labelledby="general-setting">
                    <div class="card">
                        ...
                        <hr>
                        <div class="card-body">
                            <form action="<?php echo e(route('developer-section.submit')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/developer_section/general.blade.php ENDPATH**/ ?>