<div class="tab-pane fade" id="bugUpdateSetting" role="tabpanel" aria-labelledby="bug-update-setting">
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="<?php echo e(route('bug-update-setting.submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <?php if(isset($bugSettings->short_note)): ?>
                            <textarea name="short_note" class="form-control" rows="5"><?php echo e($bugSettings->short_note); ?></textarea>
                        <?php else: ?>
...
<?php /**PATH /home/abdullah/Downloads/POS/SalePro/resources/views/developer_section/bug_update_setting.blade.php ENDPATH**/ ?>